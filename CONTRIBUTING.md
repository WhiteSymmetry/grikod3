...
To report a bug, first make sure there isn't already an open [GitHub Issue](https://github.com/WhiteSymmetry/grikod3/issues)
...
* The grikod3 version you are using.
* Detailed steps to reproduce the bug.
* A tag, if appropriate (_e.g._, "bug" or "enhancement").

### Fix Open Issues

Look through the [GitHub Issues](https://github.com/WhiteSymmetry/grikod3/issues) for any
...
Ready to contribute? Here's how to set up grikod3 for local development.
...
2. Create your own fork of the grikod3 [repository](https://github.com/WhiteSymmetry/grikod3).
...
Please note that the grikod3 project is released with a
